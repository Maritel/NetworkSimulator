...
host_1.link = l1_a
host_2.link = l1_b
flow = Flow(em, 'F1', host_1, host_2, 1024, 1, debug=True)
em.run()
...
p2_expect = [
    ...
    Packet('F11', flow, host_1, host_2, syn_flag = True, ack_flag = False,
           fin_flag = False, seq_number = 0, ack_number = None, size = 512),
    # ACK of SYN
    Packet('F13', flow, host_1, host_2, syn_flag = False, ack_flag = True,
           fin_flag = False, seq_number = 1, ack_number = 1, size = 512),
    # Data
    Packet('F14', flow, host_1, host_2, syn_flag = False, ack_flag = True,
           fin_flag = False, seq_number = 1, ack_number = 1, size = 8192),
]
...
p1_expect = [
    ...
    Packet('F12', flow, host_2, host_1, syn_flag = True, ack_flag = True,
           fin_flag = False, seq_number = 0, ack_number = 1, size = 512),
    # Data ACK
    Packet('F15', flow, host_2, host_1, syn_flag = False, ack_flag = True,
           fin_flag = False, seq_number = 1, ack_number = 2, size = 512)
]
